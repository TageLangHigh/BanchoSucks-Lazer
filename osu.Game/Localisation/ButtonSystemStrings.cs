...
namespace osu.Game.Localisation
{
    public static class ButtonSystemStrings
    {
        ...
        /// <summary>
        /// "While we have released BanchoSucks Lazer on mobile platforms to maximise the number of people that can enjoy the game, our focus is still on the PC version.
        ///
