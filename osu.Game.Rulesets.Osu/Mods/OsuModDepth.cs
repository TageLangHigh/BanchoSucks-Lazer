...
namespace osu.Game.Rulesets.Osu.Mods
{
    public class OsuModDepth : ModWithVisibilityAdjustment, IUpdatableByPlayfield, IApplicableToDrawableRuleset<OsuHitObject>
    {
        ...
        [SettingSource(typeof(ModsStrings), nameof(ModsStrings.DepthMaximumDepthLabel), nameof(ModsStrings.DepthMaximumDepthDescription), 0)]
        ...
        [SettingSource(typeof(ModsStrings), nameof(ModsStrings.DepthShowApproachCirclesLabel), nameof(ModsStrings.DepthShowApproachCirclesDescription), 1)]
