...
namespace osu.Game.Rulesets.Osu.Mods
{
    public class OsuModApproachDifferent : Mod, IApplicableToDrawableHitObject, IRequiresApproachCircles
    {
        ...
        public override LocalisableString Description => ModsStrings.ApproachDifferentDescription;
        ...
        [SettingSource(typeof(ModsStrings), nameof(ModsStrings.ApproachDifferentInitialSizeLabel), nameof(ModsStrings.ApproachDifferentInitialSizeDescription), 0)]
        ...
        [SettingSource(typeof(ModsStrings), nameof(ModsStrings.ApproachDifferentStyleLabel), nameof(ModsStrings.ApproachDifferentStyleDescription), 1)]
